...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.98\textwidth, height = 1.05\textwidth]{figures/architecture}}
...
\begin{figure}[ht]
  ...
  \caption{Ground Truth Label and Pseudolabel generated by our method for class \textit{Motorbike}.}
