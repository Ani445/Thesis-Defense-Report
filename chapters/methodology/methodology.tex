...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=0.98\textwidth]{methodology_cam.pdf}}
...
\begin{figure}[t]
    \centering
    \fbox{\includegraphics[width=0.94\textwidth]{figures/DecoderRFM}}
...
\begin{figure}[tbp]
    \centering
    \fbox{\includegraphics[width=0.98\textwidth]{figures/RFM}}
